...
t=IU.setPlaybackRate(t,'v1',1.5,{linked:true});t=AU.freezeAt(t,'v1',1);const frozen=TL.findClip(t,'v1').clip;assert.equal(AU.isFrozen(frozen),true);assert(Math.abs(frozen.freezeFrame.sourceTime-5.5)<.0001); // reversed: sourceIn 1 + (6 - 1.5)
